...
address="ECE180D/team2/commands"
...
# client.loop_start() --> moved to main
...
def button_callback(channel):
    ...
    client.publish('ECE180D/team2/commands', 'pressedA')
    ...
    if zmax-zmin>3500 and ymax-ymin>4500:
        print("circle")
        msg="attackc"
    elif ymax-ymin>4000:
        print("lifting up")
    ...
    if (msg!="not recognized" and msg!="idling"):
        print('Publishing...')

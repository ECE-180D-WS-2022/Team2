...
heallist=['heal','ideal','meal','deal','steel', 'wheel','feel', 'steal','heel',
        'peel','zeal','kneel','teal','real','hill','pele','eel','you','kiel',
        'recover','recorder']

# for word "defend"
dlist=['commend','defend','befriend','command','depend','fend','define','defer',
        'defeat','the','offend','send']
...
if __name__ == '__main__':
    # start client loop
    client.loop_start()
    # instantiate sig handler
    signal.signal(signal.SIGINT, signal_handler)
    # signal.pause()
    while True:
        print("waiting for speech command")
        time.sleep(2)
